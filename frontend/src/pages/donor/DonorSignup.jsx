...
export default function DonorSignup() {
  ...
  const handleChange = (e) => {
    ...
    setForm({
      ...form,
      [id]: id === "pincode" ? value.replace(/\D/g, "").slice(0, 6) : value,
      ...(id === "state" ? { district: "" } : {}),
    });
  };
          ...
          <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                value={form.state}
                onChange={handleChange}
                className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-800 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                disabled={!form.state}
                className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-800 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400"
              >
                <option value="">
