    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="w-72 border-r border-zinc-800 bg-zinc-900 p-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="flex items-center gap-4 rounded-xl bg-indigo-600 px-5 py-4 text-lg font-semibold transition hover:bg-indigo-500">
            <LayoutDashboard size={24} />
            Dashboard
          </button>

          <button className="flex items-center gap-4 rounded-xl px-5 py-4 text-lg transition hover:bg-zinc-800">
            <Clock3 size={24} />
            Pending Donations
          </button>
        ...
        {/* Logout */}
        <button className="mt-20 flex w-full items-center justify-center gap-3 rounded-xl bg-red-600 py-4 text-lg font-semibold transition hover:bg-red-500">
          <LogOut size={22} />
          Logout
        </button>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                ...
                <tr className="border-b border-zinc-800">
                  ...
                  <td>
                    <button className="rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold hover:bg-green-500">
                      Accept
                    </button>
                  </td>
                ...
                <tr className="border-b border-zinc-800">
                  ...
                  <td className="py-5">Hotel Taj</td>
                  <td>Bread & Curry</td>
                  <td>50 Packs</td>
                  ...
                  <td>
                    <button className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold hover:bg-indigo-500">
                      View
                    </button>
                  </td>
